...
OCR_COMPRESSION_FORMATS: dict[str, str] = {
    "normal": "jpeg",
    "economic": "jpeg",
    "economicplus": "jpeg",
}
...
OCR_OPTIMIZATION_LEVELS: dict[str, int] = {
    "normal": 0,
    "economic": 1,
    "economicplus": 3,
}
...
class OcrOptionsBuilder:
    ...
    def with_text_extraction(self, output_file: str) -> "OcrOptionsBuilder":
        ...
        use_separate_folder = getattr(self.settings, "separate_txt_folder", False) and getattr(
            self.settings, "txt_folder", None
        )
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"OcrOptionsBuilder(settings={type(self.settings).__name__}, options={self._options})"
        )
