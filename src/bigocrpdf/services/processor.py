...
from bigocrpdf.services.ocr_api import OcrQueue, configure_logging
from bigocrpdf.services.ocr_options_builder import OcrOptionsBuilder
...
class OcrProcessor:
    ...
    def __init__(self, settings: OcrSettings) -> None:
        ...
        self.ocr_queue: OcrQueue | None = None
    ...
    def _create_ocr_options(self, _input_file: str, output_file: str) -> dict[str, Any]:
    ...
    def register_callbacks(
        self,
        on_file_complete: Callable[[str, str, str], None] | None = None,
