...
def get_temp_sidecar_path(pdf_path: str, temp_dir: Optional[str] = None) -> str:
...
def find_extracted_text(pdf_path: str, temp_dir: Optional[str] = None) -> str:
...
def cleanup_temp_sidecar(pdf_path: str, temp_dir: Optional[str] = None) -> bool:
