...
class OcrProcessingError(BigOcrPdfError):
    ...
    def __init__(self, file_path: str, reason: str = None, exit_code: int = None):
        """Initialize the exception.
...
class ConfigurationError(BigOcrPdfError):
    ...
    def __init__(self, setting_name: str = None, reason: str = None):
        """Initialize the exception.
...
class QueueError(BigOcrPdfError):
    ...
    def __init__(self, reason: str, queue_size: int = None):
        """Initialize the exception.
...
class DependencyError(BigOcrPdfError):
    ...
    def __init__(self, dependency: str, required_version: str = None, 
        ...
        if installed_version and required_version:
            msg = (f"Dependency '{dependency}' version mismatch: "
